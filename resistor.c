...
void hitung_5gelang()
{
    ...
    char WARNA[20];
    char PERSEN = '%';
    printf("nb : masukkan dengan huruf KECIL semua (Contoh : merah)\n");
    for (N=1; N<=5; N++)
...
int main() {
	...
	while ( (GELANG<3) || (GELANG>6) ) {  //pengulangan sampai data GELANG BETUL
        printf("\tProgram Mengitung Nilai Resistansi\n");
        printf("\nnb : masukkan dengan huruf KECIL semua (Contoh : merah)\n");
	...
	printf("\n\t-------------------------------------------");
	printf("\n\tProgram ini dibuat oleh Pak Bana Handaga\n");
	printf("\tdan di edit oleh NUR ARIS PRASETYO\n\tserta bantuan teman-teman.\n");
	printf("\t-------------------------------------------");
	printf("\n\t\tTERIMA KASIH\n");
	return 0;
}
